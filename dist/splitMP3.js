...
// the above line imports the ffmpeg-static
// package that includes the ffmpeg binary
...
fs.readFile('C:\\Users\\user\\Desktop\\PROGRAMMING\\MP3Splitter\\mp3Files\\myFile.mp3', function (err, data) {
    ...
    //The color is just an indication 
...
ffmpeg.ffprobe('C:\\Users\\user\\Desktop\\PROGRAMMING\\MP3Splitter\\mp3Files\\myFile.mp3', function (err, metadata) {
    ...
    // is a callback function that takes two 
    // args: err and metadata, and  will be called once
    //  the metadata is obtained

    if (err)

    // if error is truthy then:
    ...
    //The error object can be caught and 
    ...
    ffmpeg('C:\\Users\\user\\Desktop\\PROGRAMMING\\MP3Splitter\\mp3Files\\myFile.mp3')
        ...
        // start time can be changed to where you want 
        // to start the clipping, in my case 0 seconds, 
        // the very start of the mp3 file
       ...
       .setDuration(5 * 60 + 43) 
                 // ^ ^ ^ ^ ^ ^ ^  
                // ( desiredMinutes * 60 seconds in a minute + how many seconds into split to end )
            
                // So the above will start at 0 
                // seconds with setStartTime

        // but you can specify any specific 
        // start and end times, 
        ...
        */
        ...
        //and the new name of it. 
        //In this case the first split will have a name of 
        // firstHalf.mp3, and will be placed inside the 
        // SplittedMP3 sub directory

        .on('end', function () {

        // this .on() is a callback func takes two args:
        ...
        console.log('First half of the MP3 file has been split!');
    })
        ...
        // specific stage in the Node.js event
